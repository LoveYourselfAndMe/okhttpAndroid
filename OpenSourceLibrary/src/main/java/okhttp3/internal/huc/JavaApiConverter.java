...
public final class JavaApiConverter {
   ...
   * HttpURLConnection#getRequestProperties()} for details.
   */
  ...
  /**
   * Creates a {@link CacheResponse} of the correct (sub)type using information gathered
  ...
  /**
   * Extracts the status line from the supplied Java API {@link HttpURLConnection}. As per
  ...
  /**
   * Extracts the status line from the supplied Java API {@link CacheResponse}. As per the
  ...
  /**
   * An {@link HttpURLConnection} that represents an HTTP request at the point where the
